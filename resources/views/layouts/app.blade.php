...
<head>
    ...
    <title>@yield('title', 'ticketry')</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            ...
            @else
                <div class="navbar-brand text-decoration-none pe-none user-select-none">
                    <i class="bi bi-ticket-perforated-fill me-2"></i>
                    ticketry.
                </div>
            @endif
    ...
    <footer>
        <div class="container">
            <span>&copy; {{ date('Y') }} ticketry. All rights reserved.</span>
        </div>
    </footer>
